#!/usr/bin/env python3
"""
Dog Face Detection Test Script (320x320)
测试训练好的模型在验证集上的性能
"""
...
def main(args):
    ...
    # 数据集配置
    data_yaml = str(CFG_DIR / 'datasets' / 'dog.yaml')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Dog Face Detection Test')
    parser.add_argument('--model', type=str,
                        default='runs/detect/runs/detect/dog_face_yolo26n_train_320/weights/best.pt',
                        help='模型路径 (相对于项目根目录)')
    ...
    parser.add_argument('--source', type=str,
                        default='/CodeRepo/Code/dwwang16/dataset/animal_detection/Oxford-IIIT_Pet_Dataset/dog_face/val/images',
                        help='推理图片目录')
    ...
    if not os.path.isabs(args.model):
        args.model = str(ULTRALYTICS_PATH / args.model)
